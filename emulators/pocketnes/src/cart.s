...
@	global_func chrfinish
	...
	.macro chislink_ensure_prg
	.if CHISLINK
	stmfd sp!,{r0-r3,r12,lr}
	bl_long chislink_pocketnes_ensure_prg
	str r0,[sp,#8]
	ldmfd sp!,{r0-r3,r12,lr}
	.endif
	.endm

	.macro chislink_ensure_chr
	.if CHISLINK
	stmfd sp!,{r0-r3,r12,lr}
	bl_long chislink_pocketnes_ensure_chr
	ldmfd sp!,{r0-r3,r12,lr}
	.endif
	.endm

	.macro chislink_ensure_prg32
	.if CHISLINK
	stmfd sp!,{r0-r3,r12,lr}
	mov r0,r0,lsl#2
	bl_long chislink_pocketnes_ensure_prg
	...
	.macro chislink_ensure_chr4
	.if CHISLINK
	stmfd sp!,{r0-r3,r12,lr}
	mov r0,r0,lsl#2
	mov r1,#4
	bl_long chislink_pocketnes_ensure_chr_range
	ldmfd sp!,{r0-r3,r12,lr}
	.endif
	.endm

	.macro chislink_ensure_chr8
	.if CHISLINK
	stmfd sp!,{r0-r3,r12,lr}
	mov r0,r0,lsl#3
	mov r1,#8
...
mirrorchange_boot:
	@ No frame is active yet, so install the tables without mid-frame PPU work.
	ldrb_ r1,cartflags
	tst r1,#0x18
	ldrne r0,=m0123
	stmfd sp!,{r3-r5,lr}
...
@----------------------------------------------------------------------------
	...
	.if CHISLINK
	stmfd sp!,{r0,lr}
	bl_long chislink_pocketnes_prg67
	mov r2,r0
	ldmfd sp!,{r0,lr}
	.else
...
@----------------------------------------------------------------------------
	...
	chislink_ensure_prg
	.if CHISLINK
	@ r2 is the final cache slot address returned by the LRU lookup.
	.else
	ldr_ r1,instant_prg_banks
	ldr r2,[r1,r0,lsl#PRG_BANK_LOOKUP_SHIFT_8K]
	.endif
